...
const ESRI_ARCGIS_CANVAS_GRAY = {
  name: 'arcGisCanvasGray',
  title: 'ESRI ArcGIS Gray Canvas Map (Mercator)',
  type: 'twms',
  enabled: true,
  dimensions: []
};
...
export const MAP_STYLES = [WORLDMAP, POSITRON_NL, POSITRON_NL_NOLABELS, OPENSTREETMAP_SERVICE, KNMI_NATURALEARTH2, MWS_STYLE, OPENSTREETS_NL,
  ...
  KLOKANTECH_BASIC_NL_NOLABELS, OSM_ANTARCTICA, ESRI_ARCGIS_CANVAS, ESRI_ARCGIS_CANVAS_GRAY, ESRI_ARCGIS_TOPO, ESRI_ARCGIS_SAT, ESRI_ARCGIS_OCEAN];
