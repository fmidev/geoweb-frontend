...
const FINLAND = { projection: { code: 'EPSG:3857', name: 'Mercator' }, title: 'Finland', bbox: [2130027.6714, 8295717.8458, 3541387.2369, 11159617.4257] };
const NORTHERN_EUROPE = { projection: { code: 'EPSG:3857', name: 'Mercator' }, title: 'Northern Europe', bbox: [9783.9814, 7073788.4324, 4045658.9844, 11574400.6058] };
...
export const BOUNDING_BOXES = [FINLAND, NORTHERN_EUROPE, NL, NL_NORTHSEA, WESTERN_EUROPE, EUROPE,
